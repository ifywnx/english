...
(function(){
  ...
  var NAV_ITEMS = {
    ...
    'Từ vựng': [
      ...
      {href:'tu-vung-chu-de.html', icon:'grid', text:'Từ vựng theo chủ đề cơ bản'},
      ...
      {href:'tu-hoc-thuat.html', icon:'library', text:'Từ vựng học thuật'}
    ],
    'Kỹ năng': [
    ...
    'Từ điển': [
      ...
      {href:'tu-dien-doi-thuong-3.html', icon:'library', text:'Từ vựng theo chủ đề nâng cao'}
    ],
    'Tiếng Anh chuyên ngành': [
      {href:'chuyen-nganh.html', icon:'graduation-cap', text:'Tổng quan chuyên ngành'},
